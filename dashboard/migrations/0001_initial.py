# Generated by Django 2.2.8 on 2019-12-09 14:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meet_title', models.CharField(blank=True, max_length=200)),
                ('meet_desc', models.CharField(max_length=500)),
                ('meet_contents', django_summernote.fields.SummernoteTextField(default='')),
                ...
                ('proponent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='proponent', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meet_schedule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='dashboard.Meeting')),
            ],
        ),
    ]
